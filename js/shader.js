...
(function() {
  ...
  var fragSrc = [
    ...
    '}',
    '',
    '// Marble color at a given UV coordinate',
    'vec3 marbleColor(vec2 uv, float t) {',
    '  vec2 q = vec2(',
    '    fbm(uv * 3.0 + t * 0.07),',
